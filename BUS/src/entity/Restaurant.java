...
public class Restaurant extends Shop {
	...
	public static final List getMenu(int id){ //tirar excepxiones y en lo otro decir que no se encontraron
		try {
...
public static void main(String[] args){
	 LinkedList<Plate> lista =  (LinkedList<Plate>) Restaurant.getMenu(1);
